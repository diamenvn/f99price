...
var register = function register(self) {
  form = self.closest('form');
  username = form.find('input[name="username"]');
...
__webpack_require__(/*! ./event */ "./resources/js/event.js");
usingTheme = function usingTheme() {
...
Notify = {
  show: {
    ...
    confirm: function confirm(callback) {
      var title = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "Xác nhận";
      var des = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "Bạn có chắc chắn thực hiện thao tác này?";
      var yes = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "Có";
      var no = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "Không";
      var rollback = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : undefined;
      Notiflix.Confirm.Show(title, des, yes, no, function () {
        callback();
      }, function () {
        if (!!rollback) {
          rollback();

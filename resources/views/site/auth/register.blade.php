                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body login-img">
                                    <form action="{{route('auth.postRegister')}}" method="POST" class="row m-0">
                                        <div class="col-lg-6 d-lg-block d-none py-2 px-3 text-center align-middle"><img alt="" class="img-fluid mt-5" height="230" src="{{asset('assets/images/login.png')}}" width="400"></div>
